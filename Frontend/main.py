...
img1 = Image.open(r"C:\Users\SHASHANK K\PycharmProjects\Project Files\Kidney Stone Detection\Image Formats\pred(1).jpg")
img2 = Image.open(r"C:\Users\SHASHANK K\PycharmProjects\Project Files\Kidney Stone Detection\Image Formats\pred(55).jpg")
img3 = Image.open(r"C:\Users\SHASHANK K\PycharmProjects\Project Files\Kidney Stone Detection\Image Formats\pred(61).jpg")

col1, col2, col3 = st.columns(3) #column() create 3 columns
